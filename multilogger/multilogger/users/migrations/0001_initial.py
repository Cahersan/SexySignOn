...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_user', (
            ...
            ('uuid', self.gf('djorm_pguuid.fields.UUIDField')(auto_add=True, db_index=True)),
        ))
        ...
        # Adding model 'Url'
        db.create_table('users_url', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('users', ['Url'])

        # Adding model 'Site'
        db.create_table('users_site', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('urls', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Url'])),
        ))
        db.send_create_signal('users', ['Site'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Url'
        db.delete_table('users_url')

        # Deleting model 'Site'
        db.delete_table('users_site')
    ...
    models = {
        ...
        'users.application': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['users.User']", 'symmetrical': 'False'})
        },
        'users.site': {
            'Meta': {'object_name': 'Site'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'urls': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Url']"})
        },
        'users.url': {
        ...
        'users.user': {
            ...
            'uuid': ('djorm_pguuid.fields.UUIDField', [], {'auto_add': 'True', 'db_index': 'True'})
        }
    }
