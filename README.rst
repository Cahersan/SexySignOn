...
.. code-block:: bash
    ...
    heroku run python multilogger/manage.py syncdb --noinput --settings=config.settings
    heroku run python multilogger/manage.py migrate --settings=config.settings
    heroku run python multilogger/manage.py collectstatic --settings=config.settings
